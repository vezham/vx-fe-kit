...
export const hostelRoomData: HostelRoomItem[] = [
  {
    id: 'room-0',
  ...
  filters: [
    {
      key: 'roomno',
      label: 'Room No',
      values: hostelRoomData.map(row => row.roomNo)
    },
    {
      key: 'name',
      label: 'Name',
      values: hostelRoomData.map(row => row.name as string)
    },
    {
      key: 'types',
      label: 'Types',
      values: hostelRoomData.map(row => row.hostelType as string)
    },
    {
      key: 'morefilters',
      label: 'More Filters',
