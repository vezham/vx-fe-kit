  ...
  filters: [
    {
      key: 'vehicleno',
      label: 'Vehicle No',
      values: vehiclesData.map(row => row.vehicleNo)
    },
    {
      key: 'model',
      label: 'Model',
      values: vehiclesData.map(row => row.vehicleModel)
    },
    {
      key: 'name',
      label: 'Name',
      values: vehiclesData.map(row => row.driver?.name)
    },
    {
      key: 'gps-device',
      label: 'GPS Device',
      values: vehiclesData.map(row => row.gpsDeviceId)
    },
    {
      key: 'driver',
      label: 'Driver',
