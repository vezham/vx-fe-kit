...
const dayColumns = Array.from({ length: 21 }, (_, index) => {
...
const dayWiseStudentColumns: ReportColumn[] = [
...
export const reportsByTitle: Record<string, AttendanceReportConfig> = {
  'Attendance Report': makeConfig({
  ...
  'Students Attendance Type': makeConfig({
  ...
  'Staff Report': makeConfig({
    ...
    rows: makeSummaryRows([...teacherPeople.slice(0, 9), teacherPeople[9]]),
    filters: [
      option('attendance', 'Attendance', [
        'Present',
        'Absent',
...
function makeConfig(config: {
  ...
  rows: ReportRow[]
  filters: AttendanceReportConfig['filters']
...
function makeStudentsAttendanceTypeRows(): ReportRow[] {
...
function makeDailyAttendanceRows(): ReportRow[] {
  return [
    ['III', 'A', 69, 2, '98%', '2%'],
    ['IV', 'A', 45, 7, '78%', '22%'],
    ['II', 'B', 69, 8, '89%', '11%'],
...
function makeStudentDayWiseRows(): ReportRow[] {
...
function makeTeacherDayWiseRows(): ReportRow[] {
  const subjects = [
    'Physics',
    'Computer',
    'English',
...
function makeStaffDayWiseRows(): ReportRow[] {
  const departments = [
    'Management',
    'Finance',
    'Management',
...
function makeSummaryRows(people: ReturnType<typeof person>[]): ReportRow[] {
