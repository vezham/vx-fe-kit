...
export default function AllClassesPage() {
  ...
  const resetFilters = () => {
    const emptyFilters = { roomno: null, capacity: null, status: null }
        ...
        <Table.ScrollContainer>
          <Table.Content
            ...
            <Table.Header>
              ...
              <Table.Column allowsSorting id="roomno">
                {({ sortDirection }) => (
                  <SortableHeader sortDirection={sortDirection}>
                    Room No
                  </SortableHeader>
              ...
              <Table.Column allowsSorting id="capacity">
                {({ sortDirection }) => (
                  <SortableHeader sortDirection={sortDirection}>
                    Capacity
                  </SortableHeader>
            ...
            <Table.Body renderEmptyState={() => <TableEmptyState />}>
              {paginatedRows.map(row => (
                <Table.Row
                  ...
                  <Table.Cell>{row.roomno}</Table.Cell>
        ...
        <Surface className={classNames.filterPanel}>
          ...
          <Select
            ...
            onChange={value =>
              setDraftFilters({
                ...draftFilters,
                roomno: value ? String(value) : null
              })
            }>
            <Label>Room No</Label>
            <Select.Trigger>
          ...
          <Select
            ...
            onChange={value =>
              setDraftFilters({
                ...draftFilters,
                capacity: value ? String(value) : null
              })
            }>
...
function ClassDrawer({
  ...
  const drawerTitle =
    mode === 'create' ? 'Add Classroom' : row ? `#${row.id}` : ''
...
function ClassDetailSummary({ row }: ClassDetailSummaryProps) {
  return (
    <div className={classNames.detailSummary}>
      <DetailLine label="Type" value={row.roomno} />
      <DetailLine label="Start Time" value={row.capacity} />
