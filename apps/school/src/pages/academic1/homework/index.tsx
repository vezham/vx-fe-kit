...
export default function AllClassesPage() {
  ...
  useEffect(() => {
    const openAddHomework = () => openDrawer('create', null)

    window.addEventListener('academic:homework:create', openAddHomework)
    return () =>
      window.removeEventListener('academic:homework:create', openAddHomework)
  }, [openDrawer])
      ...
      <Surface className={classNames.toolbar}>
        <div className={classNames.headerRow}>
          <div>
            ...
            <h1 className={classNames.title}>Class Homework</h1>
          </div>
        ...
        <Surface className={classNames.filterPanel}>
          ...
          <Select
            ...
            onChange={value =>
              setDraftFilters({
                ...draftFilters,
                subject: value ? String(value) : null
              })
            }>
            <Label>Subject</Label>
            <Select.Trigger>
...
function ClassDrawer({
  ...
  const drawerTitle =
    mode === 'create' ? 'Add Homework' : row ? getDrawerTitle(row) : ''
...
function getSortableValue(row: ClassRow, column: SortDescriptor['column']) {
  if (column === 'createdBy') {
