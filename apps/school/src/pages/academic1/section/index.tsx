...
export default function AllClassesPage() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('academic:section:create', openAddSchedule)
    return () =>
      window.removeEventListener('academic:section:create', openAddSchedule)
  }, [openDrawer])
  ...
  const resetFilters = () => {
    const emptyFilters = { section: null, status: null }
...
function ClassDrawer({
  ...
  const drawerTitle =
    mode === 'create' ? 'Add Section' : row ? `#${row.id}` : ''
