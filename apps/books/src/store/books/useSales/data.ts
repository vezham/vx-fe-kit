...
export const generateFakeSales = (count: number): Sales[] => {
...
export const salesData: Sales[] = generateFakeSales(10)

// const generateMockUserData = (count: number): Sales[] => {
...
//   export const salesData: Sales[] = generateMockUserData(10)
