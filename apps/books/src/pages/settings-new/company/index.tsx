  ...
  <div ref={ref} className={styles.container(className)} {...props}>
            ...
            <Badge
              ...
              content={
                <Button
                  ...
                  size="sm"
                  variant="bordered">
                  <Icon className={styles.badgeIcon} icon="solar:pen-linear" />
                </Button>
              }
    ...
    <div className={styles.grid}>
      ...
      <div className={styles.gridSection}>
        ...
        <Select defaultSelectedKeys={['delaware']} className={styles.select}>
          {states.map(state => (
    ...
    <div className={styles.grid}>
      <div className={styles.gridSection}>
        ...
        <Input className={styles.input} placeholder="V" />
      </div>
      <div className={styles.gridSection}>
        <p className={styles.inputLabel}>Entity Ending</p>
        <Input className={styles.input} placeholder="Corp" />
      </div>
    </div>
    ...
    <div className={styles.grid}>
      <div className={styles.gridSection}>
        ...
        <Input className={styles.input} placeholder="Geary 2234" />
      </div>
      <div className={styles.gridSection}>
        <p className={styles.inputLabel}>Suite</p>
        <Input className={styles.input} placeholder="#166" />
      </div>
    </div>
    ...
    <div className={styles.grid}>
      <div className={styles.gridSectiontwo}>
        ...
        <Select defaultSelectedKeys={['california']} className={styles.select}>
          {states.map(state => (
            <SelectItem key={state.value}>{state.title}</SelectItem>
          ))}
        </Select>
      ...
      <div className={styles.gridSectiontwo}>
        ...
        <Input className={styles.input} placeholder="San Francisco" />
      </div>
      <div className={styles.gridSectiontwo}>
        <p className={styles.inputLabel}>Zip Code</p>
        <Input className={styles.input} placeholder="9409" />
      </div>
    </div>
    ...
    <div className={styles.grid}>
      <div className={styles.gridSection}>
        ...
        <Input className={styles.input} placeholder="https://v.corp" />
      </div>
      <div className={styles.gridSection}>
        <p className={styles.inputLabel}>Phone</p>
        <Input className={styles.input} placeholder="+1 (555) 987-6543" />
      </div>
    </div>
