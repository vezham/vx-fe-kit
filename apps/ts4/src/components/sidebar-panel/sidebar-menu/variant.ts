...
export const getSidebarMenuItemBaseClass = ({
  ...
  return isDarkMode
    ? 'px-3 min-h-12 rounded-lg h-12 bg-black text-white'
    : 'px-3 min-h-12 rounded-lg h-12 bg-gray-200 text-black'
}
...
export const getSidebarMenuTitleClass = ({
  ...
  cn(
    ...
    'text-black', // force all titles to be black
    textColorClass,
