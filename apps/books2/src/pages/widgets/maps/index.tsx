          ...
          <div className="space-y-4 p-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="focus:ring-primary-500 w-full rounded-lg bg-white/5 py-2 pr-4 pl-10 text-sm focus:ring-2 focus:outline-none"
              />
            </div>

            {/* Recent Places */}
            <div className="space-y-2">
              <h4 className="text-muted text-sm font-medium">Recent Places</h4>
