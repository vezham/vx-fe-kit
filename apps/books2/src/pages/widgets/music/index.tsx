        ...
        <div className="flex flex-col gap-4 p-4">
          <motion.div
            ...
            <div className="text-center">
              ...
              <p className="text-muted text-sm">{currentSong.artist}</p>
            </div>
          ...
          <div className="mt-4">
            <h4 className="text-muted mb-2 text-sm font-medium">Up Next</h4>
              ...
              {songs.map((song, index) => (
                <motion.div
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-muted truncate text-xs">{song.artist}</p>
                  </div>

                  <span className="text-muted text-xs">{song.duration}</span>
                </motion.div>
              ))}
            </div>
          </div>
