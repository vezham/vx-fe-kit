...
const ContainerActions = forwardRef<'div', ContainerActionsProps>((props, ref) => {
  const {
    Component,
    slots,
    classNames,
  ...
  return (
    <Component {...getBaseProps()}>
      <Surface
        ...
        {(addAction || moreAction) && (
          <div className={slots.actionGroup({ class: classNames?.actionGroup })}>
            {addAction && (
              <Button
                isIconOnly
                size="md"
              ...
              <Dropdown>
                <Dropdown.Trigger>
                  <Button
                    ...
                    size="md"
                    variant="primary"
                    className={slots.moreButton({ class: classNames?.moreButton })}>
                    <Icon icon={moreAction.icon!} width={24} />
                  </Button>
                </Dropdown.Trigger>
  ...
  return (
    <Component >
      <Surface
        ...
        {(total || 0) > 0 && (
          <div className={slots.rightSection({ class: classNames?.rightSection })}>
