...
const tva = tv({
  slots: {
    ...
    container: '',
    compactSlackButton:
      'hover:bg-content2 flex min-h-[40px] min-w-[40px] cursor-pointer items-center justify-center gap-1 rounded-full p-2 transition-colors',
    expandedContainer: 'flex items-center gap-3',
    expandedSlackButton:
      'hover:bg-content2 flex min-h-[40px] min-w-[40px] cursor-pointer items-center gap-1 rounded-full px-2 py-1 transition-colors select-none',
    icon: '',
    compactChevron: 'text-default-600 text-[16px]',
    ...
    name: 'text-small text-muted leading-none font-semibold',
    username: 'text-small text-muted-500 tracking-tight',
    followButton: '',
    cardDescription: 'px-3 py-0',
    bio: 'text-small text-muted-500 pl-px',
    cardFooter: 'gap-3',
    statGroup: 'flex gap-1',
    statNumber: 'text-muted text-small font-semibold',
    statLabel: 'text-muted-500 text-small'
  },
  variants: {
    variant: {
  ...
  compoundVariants: [
    ...
    },
    {
      isCompact: false,
      class: {
        container: 'mb-5 flex items-center justify-between px-2'
      }
    },
    {
      isCompact: true,
