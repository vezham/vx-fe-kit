...
const ProjectsComponent: React.FC<ProjectsProps> = originalProps => {
  ...
  // Only auto-select first project on initial load if no project is selected
  useEffect(() => {
    if (!initialLoadDone && projects.length > 0 && !projectId) {
      const shouldAutoSelect = true // You can add logic here if needed
      if (shouldAutoSelect) {
  ...
  }, [projects, projectId, navigate, initialLoadDone])
  ...
  if (projects.length === 0 && !isProjectLoading) {
    return (
            ...
            <>
              <div className="flex w-full flex-col gap-3 sm:flex-row sm:justify-between">
                  ...
                  <div className="flex w-full justify-between gap-4">
                    <div className="flex flex-col gap-1">
                      ...
                      {headerContent.subtitle && (
                        <p {...getSubtitleProps()}>{headerContent.subtitle}</p>
                      )}
                    </div>
                    <div>
                      {activeTab === 'overview' && activeId && (
                        <Button
                          ...
                          onPress={handleDeleteActiveProject}>
                          <Icon
                ...
                <div {...getActionsContainerProps()}>
                  {activeTab === 'tasks' && activeId && tasks.length > 0 && (
                    <Button
