...
import { Attachment } from '../subtasks/types'
import { SubTaskDetailModalProps, useSubTaskDetailModalProps } from './types'
...
export const SubTaskDetailsModal = ({
  subtask,
  children,
  isOpen,
  onOpenChange
  ...
  const {
    ...
    hasAttachments
  } = useSubTaskDetailModalProps({ subtask, isOpen, onOpenChange })
