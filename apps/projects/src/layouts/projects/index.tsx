...
//       p => p.projectsId === Number(projectId)
//     )
//     if (projectExists) {
...
// Create context for active project
...
const ProjectLayout: React.FC<ProjectsProps> = originalProps => {
  ...
  useEffect(() => {
    ...
    if (activeProject) {
      setActiveId(activeProject.projectsId)
    }
  }, [projects, projectId, isProjectLoading, activeProject])
      ...
      <div {...getBaseProps()}>
        ...
        <div {...getContentAreaProps()}>
          {activeProject && headerContent ? (
            ...
            <div className="flex h-full flex-col items-center justify-center p-8">
              <div className="text-center">
                <div className="text-default-500 mb-4">No project selected</div>
                <p className="text-default-400 text-sm">
...
ProjectLayout.displayName = 'ProjectLayout'
export { ProjectLayout, useProjectContext }
